...
class _CartWidgetState extends State<CartWidget> {
  ...
  void _handlePaymentSuccess(PaymentSuccessResponse response) {
    makeTransaction(response.paymentId, amount);
        print(response);
    ...
    //  }
         ...
         totalItemPrice=0;
          ...
          child: Column(
            ...
            shrinkWrap: true,
              ...
              )):Flexible(child: Center(child: Text('The Cart is empty! Add some products '))),
              ListTile(
      ...
      //                MaterialPageRoute(builder: (context) => AddressPage(null)));
      //                openCheckout();
      //          },
      //          label: Text('Razorpay'),
      //        )
...
Column(
  ...
  ListTile(
...
],),Consumer<ProfileData>(builder: (context,data,child)
          {
      ...
      void makeTransaction(String paymentId, int amount) {}
}
